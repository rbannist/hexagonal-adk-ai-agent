...
class RejectMarketingImageDrivenService:
    ...
    def marketing_image_rejected(self, marketing_image_rejected_domain_event: MarketingImageRejectedEvent) -> dict:
        self.marketing_image_rejected_thin_integration_event = MarketingImageIntegrationEventsFactory().create_from_domain_event(marketing_image_rejected_domain_event)
