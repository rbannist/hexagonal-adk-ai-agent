...
class RemoveMarketingImageDrivenService:
    ...
    def marketing_image_removed(self, marketing_image_removed_domain_event: MarketingImageRemovedEvent) -> dict:
        self.marketing_image_removed_thin_integration_event = MarketingImageIntegrationEventsFactory().create_from_domain_event(marketing_image_removed_domain_event)
