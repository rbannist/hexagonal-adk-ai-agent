...
class RejectMarketingImageData:
    """Represents the data payload for a RejectMarketingImageCommand."""
    def __init__(
        self,
        request_id: str,
        request_time: str,
...
class RejectMarketingImageCommand(Command):
    def __init__(
        self,
        data: Dict[str, Any],
        source: str,
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any]) -> "RejectMarketingImageCommand":
        command_data = data.copy()
        command_data.pop("type", None)
        command_data["data"] = RejectMarketingImageData(**command_data["data"])
